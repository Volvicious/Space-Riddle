...
#line 93
mov r1.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r0.y, r1.xyzw, t3.yxzw  // fOpaqueDepth<0:Inf>
nop 
...
mov r0.z, r0.z  // fOpaqueViewPosZ<0:NaN:Inf>
mov r0.z, r0.z  // uOpaqueZ<0>

#line 108
ne r0.y, r0.y, l(0.000000)
if_nz r0.y
  atomic_umax g0, l(0), r0.z  // ldsZMax<0>
  atomic_umin g1, l(0), r0.z  // ldsZMin<0>
