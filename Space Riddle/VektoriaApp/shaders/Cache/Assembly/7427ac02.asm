...
#line 85 "\\?\C:\Projects\Vektoria_2015-05-22_V13withPatch4\Vektoria\trunk\VektoriaApp\shaders\source\depthoffield.hlsl"
nop 
ftoi r0.xy, v0.xyxx
mov r0.zw, l(0,0,0,0)
...
ftoi r1.xy, v0.xyxx
mov r1.zw, l(0,0,0,0)
ldms_indexable(texture2dms)(float,float,float,float) r0.z, r1.xyzw, t22.yzxw, l(0)
