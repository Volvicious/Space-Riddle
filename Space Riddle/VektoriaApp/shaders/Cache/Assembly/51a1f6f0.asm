...
// g_depthTexture                    texture   float       2dMS2    3        1
...
if_z r0.x
  ...
  store_raw g8.x, l(0), l(0)  // ldsVPLIdxCounterA<0>
  store_raw g9.x, l(0), l(1024)  // ldsVPLIdxCounterB<0>
...
mov x12[0].xyz, r3.xyzx  // f4Frustum<0,1,2>
...
mov x12[1].xyz, r2.xywx  // f4Frustum<4,5,6>
...
mov x12[2].xyz, r2.xyzx  // f4Frustum<8,9,10>
...
mov x12[3].xyz, r0.yzwy  // f4Frustum<12,13,14>
...
loop 
  ...
  breakc_z r0.w
  nop 
  mov r2.xyz, x12[r0.z + 0].zxyz  // f4Frustum<2:NaN:Inf,0:NaN:Inf,1:NaN:Inf>
  mov r2.xyz, r2.xyzx  // f4b<2:NaN:Inf,0:NaN:Inf,1:NaN:Inf>
  iadd r0.w, r0.z, l(1)
  and r2.w, r0.w, l(3)
  mov r3.xyz, x12[r2.w + 0].yzxy  // f4Frustum<1:NaN:Inf,2:NaN:Inf,0:NaN:Inf>
...
#line 219
  mov x11[r0.z + 0].xyz, r2.xyzx  // f4FrustumEqn[r0.z]<0:Inf,1:Inf,2:Inf>
  mov r0.z, r0.w  // i<0>
endloop 
...
#line 123
mov r1.zw, l(0,0,0,0)
ldms_indexable(texture2dms)(float,float,float,float) r0.y, r1.xyzw, t3.yxzw, l(0)  // fOpaqueDepth0<0:Inf>
nop 
mov r0.y, r0.y  // z<0:Inf>

#line 105 "constant.h"
mul r0.z, r0.y, cb2[15].z
add r0.z, r0.z, cb2[15].w
div r0.z, l(1.000000), r0.z  // z<0:NaN:Inf>
mov r0.z, r0.z  // ConvertProjDepthToView<0:NaN:Inf>

#line 124 "\\?\C:\Projects\Vektoria_2015-05-22_V13withPatch4\Vektoria\trunk\VektoriaApp\shaders\Source\tiling.hlsl"
mov r0.z, r0.z  // fOpaqueViewPosZ0<0:NaN:Inf>

#line 136
ne r0.y, r0.y, l(0.000000)
if_nz r0.y
  max r2.y, r0.z, l(0.000000)  // fMaxZForThisPixel<0:Inf:[-0f,1.#INFf]>
  min r2.x, r0.z, l(340282346638528860000000000000000000000.000000)  // fMinZForThisPixel<0:Inf>

#line 136
else 
  mov r2.xy, l(340282346638528860000000000000000000000.000000,0,0,0)  // fMinZForThisPixel<0: 3.40282e+038f>, fMaxZForThisPixel<0: 0f>
endif 

#line 142
mov r0.y, l(1)  // uSampleIdx<0: 1u>
mov r3.xy, r2.yxyy  // fMaxZForThisPixel<0:Inf:[-0f,1.#INFf]>, fMinZForThisPixel<0:Inf>
mov r3.z, r0.y  // uSampleIdx<0:[1u,2u]>
loop 
  ult r0.z, r3.z, l(2)
  breakc_z r0.z
  mov r4.xy, r1.xyxx
  mov r0.z, r3.z
  mov r4.zw, l(0,0,0,0)
  ldms_indexable(texture2dms)(float,float,float,float) r0.z, r4.xyzw, t3.yzxw, r0.z  // fOpaqueDepth<0:Inf>
  nop 
...
#line 145 "\\?\C:\Projects\Vektoria_2015-05-22_V13withPatch4\Vektoria\trunk\VektoriaApp\shaders\Source\tiling.hlsl"
  mov r0.w, r0.w  // fOpaqueViewPosZ<0:NaN:Inf>

#line 157
  ne r0.z, r0.z, l(0.000000)
  if_nz r0.z
    max r3.x, r0.w, r3.x  // fMaxZForThisPixel<0:Inf:[-0f,1.#INFf]>
    min r3.y, r0.w, r3.y  // fMinZForThisPixel<0:Inf>

#line 157
  endif 

#line 142
  iadd r3.z, r3.z, l(1)  // uSampleIdx<0:[2u,3u]>
endloop 

#line 165
mov r3.x, r3.x  // uZMaxForThisPixel<0>
mov r3.y, r3.y  // uZMinForThisPixel<0>
atomic_umax g0, l(0), r3.x  // ldsZMax<0>
atomic_umin g1, l(0), r3.y  // ldsZMin<0>
...
#line 247
  ...
  mov r2.xyz, x11[0].xyzx  // f4FrustumEqn<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 247
  lt r1.w, r1.w, r1.z
  nop 
  mov r2.xyz, x11[1].xyzx  // f4FrustumEqn<4:NaN:Inf,5:NaN:Inf,6:NaN:Inf>
  mov r2.xyz, r2.xyzx  // f4eqn<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 248
  ...
  and r1.w, r1.w, r2.x
  nop 
  mov r2.xyz, x11[2].xyzx  // f4FrustumEqn<8:NaN:Inf,9:NaN:Inf,10:NaN:Inf>
  mov r2.xyz, r2.xyzx  // f4eqn<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 249
  ...
  and r1.w, r1.w, r2.x
  nop 
  mov r2.xyz, x11[3].xyzx  // f4FrustumEqn<12:NaN:Inf,13:NaN:Inf,14:NaN:Inf>
  mov r2.xyz, r2.xyzx  // f4eqn<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 295
umin r1.y, cb4[0].x, cb2[25].x  // uNumVPLs<0>
...
loop 
  ult r1.w, r1.z, r1.y
  breakc_z r1.w
  ld_structured_indexable(structured_buffer, stride=16)(mixed,mixed,mixed,mixed) r2.x, r1.z, l(0), t2.xxxx  // g_VPLCenterAndRadiusBuffer<0>
  ld_structured_indexable(structured_buffer, stride=16)(mixed,mixed,mixed,mixed) r2.y, r1.z, l(4), t2.xxxx  // g_VPLCenterAndRadiusBuffer<0>
  ld_structured_indexable(structured_buffer, stride=16)(mixed,mixed,mixed,mixed) r2.z, r1.z, l(8), t2.xxxx  // g_VPLCenterAndRadiusBuffer<0>
  ld_structured_indexable(structured_buffer, stride=16)(mixed,mixed,mixed,mixed) r1.w, r1.z, l(12), t2.xxxx  // g_VPLCenterAndRadiusBuffer<0>
  mov r1.w, r1.w  // f4Center<3>
  mov r1.w, r1.w  // fR<0>
  mov r2.w, l(1.000000)
  dp4 r3.x, r2.xyzw, cb2[0].xyzw  // f4Center<0:NaN:Inf>
  dp4 r3.y, r2.xyzw, cb2[1].xyzw  // f4Center<1:NaN:Inf>
...
#line 305
  lt r2.x, r2.x, r1.w
  nop 
  mov r2.yzw, x11[1].xxyz  // f4FrustumEqn<4:NaN:Inf,5:NaN:Inf,6:NaN:Inf>
  mov r2.yzw, r2.yyzw  // f4eqn<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>

#line 87
  dp3 r2.y, r2.yzwy, r3.xyzx  // GetSignedDistanceFromPlane<0:NaN:Inf>

#line 306
  lt r2.y, r2.y, r1.w
  and r2.x, r2.y, r2.x
  nop 
  mov r2.yzw, x11[2].xxyz  // f4FrustumEqn<8:NaN:Inf,9:NaN:Inf,10:NaN:Inf>
  mov r2.yzw, r2.yyzw  // f4eqn<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 307
  ...
  and r2.x, r2.y, r2.x
  nop 
  mov r2.yzw, x11[3].xxyz  // f4FrustumEqn<12:NaN:Inf,13:NaN:Inf,14:NaN:Inf>
  mov r2.yzw, r2.yyzw  // f4eqn<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 313
      imm_atomic_iadd r4.x, g8, l(0), l(1)  // uDstIdx<0>
      store_structured g10.x, r4.x, l(0), r1.z  // ldsVPLIdx<0>
...
#line 319
      imm_atomic_iadd r2.x, g9, l(0), l(1)  // uDstIdx<0>
      store_structured g10.x, r2.x, l(0), r1.z  // ldsVPLIdx<0>
...
#line 399
  ...
  and r0.z, r0.z, l(0x0000ffff)  // uHalfZBitsLow<0:[0u,65535u]>
  imad r1.z, cb2[24].y, r0.y, l(0)
  store_uav_typed u1.xyzw, r1.zzzz, r1.yyyy  // g_perTileSpotLightIndexBufferOut<0>
  imad r1.y, cb2[24].y, r0.y, l(1)
  store_uav_typed u1.xyzw, r1.yyyy, r0.zzzz  // g_perTileSpotLightIndexBufferOut<0>

#line 406
  imad r0.z, cb2[24].y, r0.y, l(2)
  ld_raw r1.y, l(0), g5.xxxx  // ldsSpotLightIdxCounterA<0>
  store_uav_typed u1.xyzw, r0.zzzz, r1.yyyy  // g_perTileSpotLightIndexBufferOut<0>
  imad r0.z, cb2[24].y, r0.y, l(3)
  ld_raw r1.y, l(0), g6.xxxx  // ldsSpotLightIdxCounterB<0>
  iadd r1.y, r1.y, l(-272)
  store_uav_typed u1.xyzw, r0.zzzz, r1.yyyy  // g_perTileSpotLightIndexBufferOut<0>
...
mov r0.z, r1.x  // i<0>
loop 
  ld_raw r1.y, l(0), g8.xxxx  // ldsVPLIdxCounterA<0>
  ult r1.y, r0.z, r1.y
  breakc_z r1.y

#line 420
  imad r1.y, cb2[25].z, r0.y, r0.z
  iadd r1.y, r1.y, l(4)
  ld_structured r1.z, r0.z, l(0), g10.xxxx  // ldsVPLIdx<0>
  store_uav_typed u2.xyzw, r1.yyyy, r1.zzzz  // g_perTileVPLIndexBufferOut<0>
...
mov r0.z, r1.x  // j<0>
loop 
  ld_raw r1.y, l(0), g9.xxxx  // ldsVPLIdxCounterB<0>
...
#line 426
  imad r1.y, cb2[25].z, r0.y, r0.z
  iadd r1.y, r1.y, l(4)
  iadd r1.y, r1.y, cb2[25].y
  iadd r0.z, r0.z, l(1024)
  ld_structured r1.z, r0.z, l(0), g10.xxxx  // ldsVPLIdx<0>
  store_uav_typed u2.xyzw, r1.yyyy, r1.zzzz  // g_perTileVPLIndexBufferOut<0>
...
#line 432
  ...
  imad r0.w, cb2[25].z, r0.y, l(0)
  store_uav_typed u2.xyzw, r0.wwww, r0.xxxx  // g_perTileVPLIndexBufferOut<0>
  imad r0.x, cb2[25].z, r0.y, l(1)
  store_uav_typed u2.xyzw, r0.xxxx, r0.zzzz  // g_perTileVPLIndexBufferOut<0>

#line 439
  imad r0.x, cb2[25].z, r0.y, l(2)
  ld_raw r0.z, l(0), g8.xxxx  // ldsVPLIdxCounterA<0>
  store_uav_typed u2.xyzw, r0.xxxx, r0.zzzz  // g_perTileVPLIndexBufferOut<0>
  imad r0.x, cb2[25].z, r0.y, l(3)
  ld_raw r0.y, l(0), g9.xxxx  // ldsVPLIdxCounterB<0>
  iadd r0.y, r0.y, l(-1024)
  store_uav_typed u2.xyzw, r0.xxxx, r0.yyyy  // g_perTileVPLIndexBufferOut<0>
