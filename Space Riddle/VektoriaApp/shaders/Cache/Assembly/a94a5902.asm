...
mov r3.xy, r2.yxyy  // fMaxZForThisPixel<0:Inf>, fMinZForThisPixel<0:Inf>
mov r3.z, r0.y  // uSampleIdx<0>
loop 
  ult r0.z, r3.z, l(4)
  breakc_z r0.z
  mov r4.xy, r1.xyxx
...
#line 157
  ...
  if_nz r0.z
    max r3.x, r0.w, r3.x  // fMaxZForThisPixel<0:Inf>
...
#line 142
  iadd r3.z, r3.z, l(1)  // uSampleIdx<0>
endloop 
