...
#line 86 "\\?\C:\Projects\Vektoria_2015-05-22_V13withPatch4\Vektoria\trunk\VektoriaApp\shaders\Source\forwardShading.hlsl"
...
mov r0.xyzw, r0.xyzw  // output<18:NaN:Inf,19:NaN:Inf,20:NaN:Inf,21:NaN:Inf>
dp3 r2.x, v1.xyzx, cb0[0].xyzx  // output<4:NaN:Inf>
dp3 r2.y, v1.xyzx, cb0[1].xyzx  // output<5:NaN:Inf>
dp3 r2.z, v1.xyzx, cb0[2].xyzx  // output<6:NaN:Inf>
dp3 r3.x, v3.xyzx, cb0[0].xyzx  // output<7:NaN:Inf>
dp3 r3.y, v3.xyzx, cb0[1].xyzx  // output<8:NaN:Inf>
dp3 r3.z, v3.xyzx, cb0[2].xyzx  // output<9:NaN:Inf>
dp3 r4.x, v4.xyzx, cb0[0].xyzx  // output<10:NaN:Inf>
dp3 r4.y, v4.xyzx, cb0[1].xyzx  // output<11:NaN:Inf>
dp3 r4.z, v4.xyzx, cb0[2].xyzx  // output<12:NaN:Inf>
mov r5.xy, v2.xyxx  // output<13,14>

#line 100
dp4 r6.x, l(0.000000, 0.000000, 0.000000, 1.000000), cb2[4].xyzw  // output<15>
dp4 r6.y, l(0.000000, 0.000000, 0.000000, 1.000000), cb2[5].xyzw  // output<16>
dp4 r6.z, l(0.000000, 0.000000, 0.000000, 1.000000), cb2[6].xyzw  // output<17>
mov o0.xyzw, r1.xyzw  // RenderSceneVS<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf,3:NaN:Inf>
mov o6.xyzw, r0.xyzw  // RenderSceneVS<18:NaN:Inf,19:NaN:Inf,20:NaN:Inf,21:NaN:Inf>
mov o1.xyz, r2.xyzx  // RenderSceneVS<4:NaN:Inf,5:NaN:Inf,6:NaN:Inf>
mov o2.xyz, r3.xyzx  // RenderSceneVS<7:NaN:Inf,8:NaN:Inf,9:NaN:Inf>
mov o3.xyz, r4.xyzx  // RenderSceneVS<10:NaN:Inf,11:NaN:Inf,12:NaN:Inf>
mov o5.xyz, r6.xyzx  // RenderSceneVS<15,16,17>
mov o4.xy, r5.xyxx  // RenderSceneVS<13,14>
ret 
