...
// g_blendedDepthTexture             texture   float        2dMS    4        1
...
#line 123
mov r1.zw, l(0,0,0,0)
ldms_indexable(texture2dms)(float,float,float,float) r0.y, r1.xyzw, t3.yxzw, l(0)
mov r0.y, r0.y  // fOpaqueDepth0<0:Inf>
nop 
...
mov r0.y, r0.y  // fOpaqueViewPosZ0<0:NaN:Inf>

#line 127
mov r2.xy, r1.xyxx
mov r2.zw, l(0,0,0,0)
ldms_indexable(texture2dms)(float,float,float,float) r0.z, r2.xyzw, t4.yzxw, l(0)  // fBlendedDepth0<0:Inf>
nop 
...
#line 128 "\\?\C:\Projects\Vektoria_2015-05-22_V13withPatch4\Vektoria\trunk\VektoriaApp\shaders\Source\tiling.hlsl"
mov r0.w, r0.w  // fBlendedViewPosZ0<0:NaN:Inf>
ne r0.z, r0.z, l(0.000000)
if_nz r0.z
  max r2.y, r0.y, l(0.000000)  // fMaxZForThisPixel<0:Inf:[-0f,1.#INFf]>
  min r2.x, r0.w, l(340282346638528860000000000000000000000.000000)  // fMinZForThisPixel<0:Inf>
...
loop 
  ...
  mov r0.z, r3.z
  mov r4.zw, l(0,0,0,0)
  ldms_indexable(texture2dms)(float,float,float,float) r0.w, r4.xyzw, t3.yzwx, r0.z
  mov r0.w, r0.w  // fOpaqueDepth<0:Inf>
  nop 
  mov r0.w, r0.w  // z<0:Inf>

#line 105 "constant.h"
  mul r0.w, r0.w, cb2[15].z
  add r0.w, r0.w, cb2[15].w
  div r0.w, l(1.000000), r0.w  // z<0:NaN:Inf>
  mov r0.w, r0.w  // ConvertProjDepthToView<0:NaN:Inf>
...
#line 148
  mov r4.xy, r1.xyxx
  mov r4.zw, l(0,0,0,0)
  ldms_indexable(texture2dms)(float,float,float,float) r0.z, r4.xyzw, t4.yzxw, r0.z  // fBlendedDepth<0:Inf>
  nop 
  mov r0.z, r0.z  // z<0:Inf>

#line 105 "constant.h"
  mul r1.z, r0.z, cb2[15].z
  add r1.z, r1.z, cb2[15].w
  div r1.z, l(1.000000), r1.z  // z<0:NaN:Inf>
  mov r1.z, r1.z  // ConvertProjDepthToView<0:NaN:Inf>

#line 149 "\\?\C:\Projects\Vektoria_2015-05-22_V13withPatch4\Vektoria\trunk\VektoriaApp\shaders\Source\tiling.hlsl"
  mov r1.z, r1.z  // fBlendedViewPosZ<0:NaN:Inf>
  ne r0.z, r0.z, l(0.000000)
  if_nz r0.z
    max r3.x, r0.w, r3.x  // fMaxZForThisPixel<0:Inf:[-0f,1.#INFf]>
    min r3.y, r1.z, r3.y  // fMinZForThisPixel<0:Inf>
