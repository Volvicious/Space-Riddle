...
#line 35 "\\?\C:\Projects\Vektoria_2015-05-22_V13withPatch4\Vektoria\trunk\VektoriaApp\shaders\source\BloomPost.hlsl"
...
mov o0.xyzw, r1.xyzw  // VS_BLOOMTEXTURE<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf,3:NaN:Inf>
mov o1.xy, r0.xyxx  // VS_BLOOMTEXTURE<4,5>
mov o2.xyzw, l(0,0,0,0)  // VS_BLOOMTEXTURE<6: 0f,7: 0f,8: 0f,9: 0f>
ret 
