...
ld_indexable(buffer)(uint,uint,uint,uint) r3.w, r2.wwww, t4.yzwx
movc r3.w, r5.w, r8.w, r3.w  // uNumLights<0>
...
loop 
  ...
  ult r8.w, r5.w, r8.w
  breakc_z r8.w
  ld_indexable(buffer)(uint,uint,uint,uint) r8.w, r5.wwww, t4.yzwx  // uLightIndex<0>

#line 387
  nop 
  mov r9.w, r8.w  // uLightIndex<0>
...
#line 200
  ...
  if_nz r11.w
    ...
    min r10.w, r10.w, l(1.000000)  // fFallOff<0:[0f,1f]>

#line 207
    ld_indexable(buffer)(float,float,float,float) r20.xyz, r9.wwww, t3.xyzw
    nop 
...
#line 161 "ggxlighting.h"
    ...
    rsq r14.w, r14.w
    mul r21.xyz, r14.wwww, r21.xyzx  // f3N<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    ...
    sqrt r17.x, r16.w
    lt r18.z, r17.x, r15.w
    dp3 r18.w, r25.xyzx, r25.xyzx
    sqrt r19.w, r18.w
    lt r20.w, r19.w, r15.w
    or r18.z, r18.z, r20.w
    if_nz r18.z
      rsq r14.w, r14.w
      mul r23.xyz, r14.wwww, r23.xyzx  // f3X<0:NaN:Inf,1:NaN:Inf,2: 0f>
    else 

#line 172
      lt r14.w, r15.w, r17.x
      lt r15.w, r19.w, r17.x
      or r14.w, r14.w, r15.w
      if_nz r14.w
        rsq r14.w, r16.w
        mul r23.xyz, r14.wwww, r24.xyzx  // f3X<0:NaN:Inf,1: 0f,2:NaN:Inf>
      else 

#line 178
        rsq r14.w, r18.w
        mul r23.xyz, r14.wwww, r25.xyzx  // f3X<0: 0f,1:NaN:Inf,2:NaN:Inf>
...
#line 180
    ...
    rsq r14.w, r14.w
    mul r24.xyz, r14.wwww, r24.xyzx  // f3Y<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    add r25.xyz, r13.xyzx, r15.xyzx
    dp3 r14.w, r25.xyzx, r25.xyzx
    rsq r14.w, r14.w
    mul r26.xyz, r14.wwww, r25.xyzx  // f3H<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    dp3 r23.x, r25.xyzx, r23.xyzx
    dp3 r23.y, r25.xyzx, r24.xyzx
    dp3 r23.z, r25.xyzx, r21.xyzx
    dp3 r14.w, r23.xyzx, r23.xyzx
    rsq r14.w, r14.w
    mul r23.xyz, r14.wwww, r23.xyzx  // f3Ht<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>

#line 187
    dp3 r14.w, r13.xyzx, r13.xyzx
    sqrt r14.w, r14.w  // f3Llength<0:NaN:Inf>
    dp3 r15.w, r15.xyzx, r15.xyzx
    sqrt r15.w, r15.w  // f3Vlength<0:NaN:Inf>
    dp3 r16.w, r21.xyzx, r13.xyzx  // fDotNL<0:NaN:Inf>
    dp3 r17.x, r21.xyzx, r15.xyzx  // fDotNV<0:NaN:Inf>
    div r16.w, r16.w, r14.w  // fDotNL<0:NaN:Inf>
    div r15.w, r17.x, r15.w  // fDotNV<0:NaN:Inf>

#line 197
    dp3 r17.x, r21.xyzx, r26.xyzx  // fDotNH<0:NaN:Inf>
    div r24.xyz, r13.xyzx, r14.wwww
    dp3 r14.w, r24.xyzx, r26.xyzx  // fDotLH<0:NaN:Inf>
    nop 
    mov r22.xyz, r22.xyzx  // f3Color<0:Inf,1:Inf,2:Inf>

#line 118
    mov r18.z, -r22.x
    max r18.z, r18.z, r22.x
    log r18.z, r18.z
    mul r18.z, r18.z, l(2.200000)
    exp r24.x, r18.z  // Mon2Lin<0:Inf:[0f,1.#INFf]>
    mov r18.z, -r22.y
    max r18.z, r18.z, r22.y
    log r18.z, r18.z
    mul r18.z, r18.z, l(2.200000)
    exp r24.y, r18.z  // Mon2Lin<1:Inf:[0f,1.#INFf]>
    mov r18.z, -r22.z
    max r18.z, r18.z, r22.z
    log r18.z, r18.z
    mul r18.z, r18.z, l(2.200000)
    exp r24.z, r18.z  // Mon2Lin<2:Inf:[0f,1.#INFf]>

#line 200
    mov r24.xyz, r24.xyzx  // f3CdLin<0:Inf:[0f,1.#INFf],1:Inf:[0f,1.#INFf],2:Inf:[0f,1.#INFf]>
    mul r18.z, r24.x, l(0.300000)
    mul r18.w, r24.y, l(0.600000)
    add r18.z, r18.w, r18.z
    mul r18.w, r24.z, l(0.100000)
    add r18.z, r18.w, r18.z  // fCdLum<0:NaN:Inf>

#line 204
    lt r18.w, l(0.000000), r18.z
    div r22.xyz, r24.xyzx, r18.zzzz
    movc r22.xyz, r18.wwww, r22.xyzx, l(1.000000,1.000000,1.000000,0)  // f3CTint<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r18.z, l(0.080000), cb5[10].z
...
#line 41
    ...
    mul r18.w, r18.z, r18.z  // fm2<0:[0f,1f]>
    mul r18.w, r18.w, r18.w
    mul r18.z, r18.z, r18.w  // SchlickFresnel<0:[-0f,1f]>

#line 210
    mov r18.z, r18.z  // fFL<0:[-0f,1f]>
    nop 
...
#line 214
    ...
    mov r12.w, r12.w  // fRoughness<0>

#line 48
    mov r19.w, r12.w  // fSigma<0>

#line 51
    dp3 r20.w, r15.xyzx, r21.xyzx  // fVDotN<0:NaN:Inf>
    dp3 r21.w, r13.xyzx, r21.xyzx  // fLDotN<0:NaN:Inf>
    dp3 r22.w, r13.xyzx, r13.xyzx
    sqrt r22.w, r22.w  // f3Llength<0:NaN:Inf>
    dp3 r23.w, r15.xyzx, r15.xyzx
    sqrt r23.w, r23.w  // f3Vlength<0:NaN:Inf>
    div r20.w, r20.w, r23.w  // fVDotN<0:NaN:Inf>
    div r21.w, r21.w, r22.w  // fLDotN<0:NaN:Inf>
    mov r22.w, -r20.w
    max r23.w, r20.w, r22.w
    mov r24.w, -r23.w
...
#line 63
    ...
    and r21.w, r21.w, r25.x
    add r21.w, r21.w, r24.w  // fThetaI<0:NaN:Inf>
    max r23.w, r22.w, r21.w  // fAlpha<0:NaN:Inf>
    min r21.w, r22.w, r21.w  // fBeta<0:NaN:Inf>
    lt r22.w, l(1.570796), r23.w
    if_nz r22.w
      mov r24.w, l(0)  // OrenNayar<0: 0f>
    endif 
    if_z r22.w
      mul r22.w, r19.w, l(0.500000)
      add r25.x, r19.w, l(0.330000)
      div r22.w, r22.w, r25.x
      mov r22.w, -r22.w
      add r22.w, r22.w, l(1.000000)  // fC1<0:NaN:Inf>
      mul r25.x, r19.w, l(0.450000)
      add r25.y, r19.w, l(0.090000)
      div r25.x, r25.x, r25.y  // fC2<0:NaN:Inf>
      ge r25.z, r20.w, l(0.000000)
      if_nz r25.z
...
#line 143
    ...
    add r19.xy, r18.wwww, r19.xyxx  // f3M<0:NaN:Inf,1:NaN:Inf>
    mul r25.xy, r18.xyxx, r18.xyxx
    mul r25.z, r18.y, r18.x
    mov r25.xyz, -r25.xyzx
    add r19.xyz, r19.xyzx, r25.xyzx  // f3Sigma<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r18.w, r19.y, r19.x
    mul r19.w, r19.z, r19.z
    mov r19.w, -r19.w
    add r18.w, r18.w, r19.w  // fDet<0:NaN:Inf>
    div r23.xy, r23.xyxx, r23.zzzz
    mov r18.xy, -r18.xyxx
    add r18.xy, r18.xyxx, r23.xyxx  // f2H<0:NaN:Inf,1:NaN:Inf>
    mul r19.w, r18.x, r18.x
    mul r19.y, r19.y, r19.w
    mul r19.w, r18.y, r18.y
...
#line 41
    ...
    mul r18.y, r14.w, r14.w  // fm2<0:[0f,1f]>
    mul r18.y, r18.y, r18.y
    mul r14.w, r14.w, r18.y  // SchlickFresnel<0:[-0f,1f]>
...
#line 232
    ...
    add r12.w, r12.w, l(0.500000)  // fx<0:[-1.70141e+038f,1.70141e+038f]>

#line 86
    mul r12.w, r12.w, r12.w  // Sqr<0:Inf:[0f,1.#INFf]>

#line 234
    mov r12.w, r12.w  // fRoughG<0:Inf:[0f,1.#INFf]>
    nop 
    mov r12.w, r12.w  // fAlphaG<0:Inf:[0f,1.#INFf]>

#line 111
    mul r12.w, r12.w, r12.w  // fa<0:NaN:Inf>
    mul r18.y, r16.w, r16.w  // fb<0:NaN:Inf>
    nop 
    add r18.w, r12.w, r18.y
    mul r19.w, r12.w, r18.y
    mov r19.w, -r19.w
    add r18.w, r18.w, r19.w  // fx<0:NaN:Inf>

#line 86
    mul r18.w, r18.w, r18.w  // Sqr<0:NaN:Inf>

#line 113
    add r18.w, r16.w, r18.w
...
#line 112
    mul r19.w, r15.w, r15.w  // fb<0:NaN:Inf>
    nop 
    add r20.w, r12.w, r19.w
    mul r12.w, r12.w, r19.w
    mov r12.w, -r12.w
    add r12.w, r12.w, r20.w  // fx<0:NaN:Inf>
...
#line 235
    mul r12.w, r12.w, r18.w  // fGs<0:NaN:Inf>

#line 249
    nop 
    mov r17.x, r17.x  // fDotNH<0:NaN:Inf>
    mul r18.w, l(-0.099000), cb5[12].y
    add r18.w, r18.w, l(0.100000)  // fa<0:[-3.3688e+037f,3.3688e+037f]>

#line 91
    ge r20.w, r18.w, l(1.000000)
    if_nz r20.w
      mov r21.w, l(0.318310)  // GTR1<0: 0.31831f>
    endif 
    if_z r20.w
      mul r18.w, r18.w, r18.w  // fa2<0:Inf:[0f,1.#INFf]>
      add r20.w, r18.w, l(-1.000000)
      mul r22.x, r17.x, r20.w
      mul r17.x, r17.x, r22.x
      add r17.x, r17.x, l(1.000000)  // fT<0:NaN:Inf>
      log r18.w, r18.w
      mul r18.w, r18.w, l(0.693147)
      mul r18.w, r18.w, l(3.141593)
      mul r17.x, r17.x, r18.w
      div r21.w, r20.w, r17.x  // GTR1<0:NaN:Inf>
    endif 

#line 249
    mov r21.w, r21.w  // fDr<0:NaN:Inf>
    mov r17.x, -r13.w
    add r17.x, r17.x, l(1.000000)
    mul r14.w, r14.w, r17.x
    add r13.w, r13.w, r14.w  // fFr<0:Inf>
    nop 

#line 113
    nop 
    add r14.w, r18.y, l(0.062500)
    mul r17.x, r18.y, l(0.062500)
    mov r17.x, -r17.x
...
#line 113
    nop 
    add r17.x, r19.w, l(0.062500)
    mul r18.y, r19.w, l(0.062500)
    mov r18.y, -r18.y
    add r17.x, r17.x, r18.y  // fx<0:NaN:Inf>
...
#line 251
    mul r14.w, r14.w, r17.x  // fGr<0:NaN:Inf>
...
#line 258
      ...
      mul r13.x, r13.x, r13.y
      mov r13.y, -r24.w
      add r13.y, r13.y, r18.z
      mul r13.y, r13.y, cb5[11].x
      add r13.y, r13.y, r24.w
      mul r13.y, r13.y, l(0.318310)
      mul r22.xyz, r24.xyzx, r13.yyyy
      add r22.xyz, r22.xyzx, cb5[11].zzzz
      mov r13.y, -cb5[10].w
      add r13.y, r13.y, l(1.000000)
      mul r22.xyz, r13.yyyy, r22.xyzx
      add r22.xyz, r22.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
      add r22.xyz, r22.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
      mul r13.xyz, r13.xxxx, r22.xyzx  // BRDF<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>

#line 256
      mov r12.w, l(0)  // fGs<0: 0f>
      mov r13.w, l(0)  // fFr<0: 0f>
    endif 
...
#line 267
        ...
        mul r15.x, r15.x, r15.y
        mov r15.y, -r24.w
        add r15.y, r15.y, r18.z
        mul r15.y, r15.y, cb5[11].x
        add r15.y, r15.y, r24.w
...
#line 276
      if_z r15.w
        ...
        mul r18.yzw, r19.xxyz, r12.wwww
        mul r18.xyz, r18.xxxx, r18.yzwy
        add r15.xyz, r15.xyzx, r18.xyzx
        mul r12.w, l(0.250000), cb5[12].x
        mul r12.w, r14.w, r12.w
        mul r12.w, r13.w, r12.w
        mul r12.w, r21.w, r12.w
        add r13.xyz, r12.wwww, r15.xyzx  // BRDF<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
      endif 
...
#line 136
    ...
    mov r12.w, -r15.z  // f3uv<2:NaN:Inf>
    nop 
...
#line 21
    ...
    lt r15.z, r14.w, r13.w
    mov r15.w, -r12.w
    max r15.w, r12.w, r15.w
    lt r16.w, r15.w, r13.w
...
#line 35
      lt r13.w, r13.w, r14.w
      lt r14.w, r15.w, r14.w
      and r13.w, r13.w, r14.w
      if_nz r13.w
        ge r13.w, r15.y, l(0.000000)
        if_nz r13.w
...
#line 139
    mov r12.w, r15.x  // iFace<0:[0,5]>
    imul null, r13.w, r15.x, l(4)
    imad r8.w, r8.w, l(24), r13.w
    mov r0.w, l(1.000000)
    dp4 r15.x, r0.xyzw, cb3[r8.w + 0].xyzw  // f4ShadowTexCoord<0:NaN:Inf>
    dp4 r15.y, r0.xyzw, cb3[r8.w + 1].xyzw  // f4ShadowTexCoord<1:NaN:Inf>
    dp4 r15.z, r0.xyzw, cb3[r8.w + 2].xyzw  // f4ShadowTexCoord<2:NaN:Inf>
    dp4 r0.w, r0.xyzw, cb3[r8.w + 3].xyzw  // f4ShadowTexCoord<3:NaN:Inf>
    ...
    div r8.w, r15.y, l(-2.000000)
    add r8.w, r8.w, l(0.500000)  // f4ShadowTexCoord<1:NaN:Inf>
    itof r12.w, r12.w
...
#line 150
    utof r0.w, r10.w
    add r0.w, r0.w, r8.w  // f4ShadowTexCoord<1:NaN:Inf>
...
#line 84
    sample_c_lz_indexable(-3,-3,0)(texture2d)(float,float,float,float) r8.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, l(0.000000)  // fShadow<0:[0f,1f]>
    sample_c_lz_indexable(-3,-2,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,2f]>
    sample_c_lz_indexable(-3,-1,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,3f]>
    sample_c_lz_indexable(-3,0,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,4f]>
    sample_c_lz_indexable(-3,1,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,5f]>
    sample_c_lz_indexable(-3,2,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,6f]>
    sample_c_lz_indexable(-3,3,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,7f]>
    sample_c_lz_indexable(-2,-3,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,8f]>
    sample_c_lz_indexable(-2,-2,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,9f]>
    sample_c_lz_indexable(-2,-1,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,10f]>
    sample_c_lz_indexable(-2,0,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,11f]>
    sample_c_lz_indexable(-2,1,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,12f]>
    sample_c_lz_indexable(-2,2,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,13f]>
    sample_c_lz_indexable(-2,3,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,14f]>
    sample_c_lz_indexable(-1,-3,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,15f]>
    sample_c_lz_indexable(-1,-2,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,16f]>
    sample_c_lz_indexable(-1,-1,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,17f]>
    sample_c_lz_indexable(-1,0,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,18f]>
    sample_c_lz_indexable(-1,1,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,19f]>
    sample_c_lz_indexable(-1,2,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,20f]>
    sample_c_lz_indexable(-1,3,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,21f]>
    sample_c_lz_indexable(0,-3,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,22f]>
    sample_c_lz_indexable(0,-2,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,23f]>
    sample_c_lz_indexable(0,-1,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,24f]>
    sample_c_lz_indexable(0,0,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,25f]>
    sample_c_lz_indexable(0,1,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,26f]>
    sample_c_lz_indexable(0,2,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,27f]>
    sample_c_lz_indexable(0,3,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,28f]>
    sample_c_lz_indexable(1,-3,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,29f]>
    sample_c_lz_indexable(1,-2,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,30f]>
    sample_c_lz_indexable(1,-1,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,31f]>
    sample_c_lz_indexable(1,0,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,32f]>
    sample_c_lz_indexable(1,1,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,33f]>
    sample_c_lz_indexable(1,2,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,34f]>
    sample_c_lz_indexable(1,3,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,35f]>
    sample_c_lz_indexable(2,-3,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,36f]>
    sample_c_lz_indexable(2,-2,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,37f]>
    sample_c_lz_indexable(2,-1,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,38f]>
    sample_c_lz_indexable(2,0,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,39f]>
    sample_c_lz_indexable(2,1,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,40f]>
    sample_c_lz_indexable(2,2,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,41f]>
    sample_c_lz_indexable(2,3,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,42f]>
    sample_c_lz_indexable(3,-3,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,43f]>
    sample_c_lz_indexable(3,-2,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,44f]>
    sample_c_lz_indexable(3,-1,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,45f]>
    sample_c_lz_indexable(3,0,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,46f]>
    sample_c_lz_indexable(3,1,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,47f]>
    sample_c_lz_indexable(3,2,0)(texture2d)(float,float,float,float) r10.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r8.w, r8.w, r10.w  // fShadow<0:[0f,48f]>
    sample_c_lz_indexable(3,3,0)(texture2d)(float,float,float,float) r0.w, r15.xyxx, t13.xxxx, s1, r0.w
    add r0.w, r0.w, r8.w  // fShadow<0:[0f,49f]>
...
#line 211
    ...
    mul r13.xyz, r0.wwww, r13.xyzx  // f3LightColorDiffuseResult<0:[0f,1f],1:[0f,1f],2:[0f,1f]>

#line 216
    mul r13.xyz, r13.xyzx, l(2.000000, 2.000000, 2.000000, 0.000000)  // f3LightColorDiffuseResult<0:[0f,2f],1:[0f,2f],2:[0f,2f]>
...
#line 387 "\\?\C:\Projects\Vektoria_2015-05-22_V13withPatch4\Vektoria\trunk\VektoriaApp\shaders\Source\forwardShading.hlsl"
  mov r13.xyz, r13.xyzx  // f3LightColorDiffuseResult<0:[-0f,2f],1:[-0f,2f],2:[-0f,2f]>

#line 397
  ine r0.w, l(0, 0, 0, 0), cb5[8].z
  if_nz r0.w
    ld_indexable(buffer)(float,float,float,float) r15.xyz, r9.wwww, t2.xyzw  // f4CenterAndRadius<0:Inf,1:Inf,2:Inf,3:Inf>
    ld_indexable(buffer)(float,float,float,float) r17.xyz, r9.wwww, t3.xyzw  // f3LightCol<0:Inf,1:Inf,2:Inf>
...
#line 405
    ...
    mov r13.xyz, r13.xyzx  // f3LightDiffuseResult<0:[-0f,2f],1:[-0f,2f],2:[-0f,2f]>
...
#line 141
    dp3 r10.w, r21.xyzx, r15.xyzx  // fProduct<0:NaN:Inf>
...
#line 179
    mul r15.xyz, r9.wwww, r10.wwww  // f4DotLN<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mov r19.xyz, -r14.xyzx
    dp3 r10.w, r19.xyzx, r21.xyzx
    max r10.w, r10.w, l(0.000000)
    mul r19.xyz, r8.wwww, r10.wwww  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    nop 

#line 141
    dp3 r10.w, r21.xyzx, r21.xyzx  // fProduct<0:NaN:Inf>
    mul r10.w, r10.w, l(0.500000)  // fProduct<0:NaN:Inf>
    add r10.w, r10.w, l(0.500000)  // fProduct<0:NaN:Inf>
    mov r10.w, r10.w  // HalfLambert<0:NaN:Inf>
...
#line 182
    ...
    add r19.xyz, r10.wwww, r19.xyzx  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r19.xyz, r9.wwww, r19.xyzx  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 193
    ...
    max r0.w, r0.w, l(0.000000)  // fEdge<0:Inf:[-0f,1.#INFf]>
...
#line 205
      ...
      mul r13.xyz, r13.xyzx, r14.xyzx  // f3LightDiffuseResult<0:[0f,2f],1:[0f,2f],2:[0f,2f]>
    else 
...
#line 432
  ...
  mov r7.xyz, r2.xyzx  // f3Position<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 256
  ...
  mul r3.w, r18.y, r18.y
  mov r3.w, -r3.w
  add r2.w, r2.w, r3.w
  sqrt r2.w, r2.w  // f3SpotLightDir<2:NaN>

#line 260
  lt r3.w, l(0.000000), r17.w
  mov r4.w, -r2.w
  movc r18.z, r3.w, r2.w, r4.w  // f3SpotLightDir<2:NaN>
  ...
  mov r7.xyz, -r7.xyzx
  add r7.xyz, r7.xyzx, r16.xyzx  // f3ToLight<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
  dp3 r2.w, r7.xyzx, r7.xyzx
  rsq r4.w, r2.w
  mul r16.xyz, r4.wwww, r7.xyzx  // f3ToLightNormalized<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
  sqrt r2.w, r2.w  // fLightDistance<0:NaN:Inf>
  mov r16.xyz, -r16.xyzx
  dp3 r4.w, r18.xyzx, r18.xyzx
  rsq r4.w, r4.w
  mul r18.xyz, r4.wwww, r18.xyzx
  dp3 r4.w, r16.xyzx, r18.xyzx  // fCosineOfCurrentAngle<0:NaN:Inf>

#line 272
  mov r17.x, r17.x  // fRad<0:Inf>
  mov r5.w, -r17.w
  movc r3.w, r3.w, r17.w, r5.w  // fCosineOfConeAngle<0:Inf>
...
#line 279
  ...
  if_nz r5.w
    ...
    div r3.w, r3.w, r4.w  // fRadialAttenuation<0:NaN:Inf>
    mul r3.w, r3.w, r3.w
    max r3.w, r3.w, l(0.000000)
    min r3.w, r3.w, l(1.000000)  // fRadialAttenuation<0:[0f,1f]>
    div r4.w, r2.w, r17.x  // fx<0:NaN:Inf>
    mul r4.w, r4.w, r4.w
    mul r4.w, r4.w, r4.w
...
#line 289
    ...
    nop 
    mov r7.xyz, r7.xyzx  // f3L<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 161 "ggxlighting.h"
    ...
    rsq r5.w, r5.w
    mul r19.xyz, r5.wwww, r19.xyzx  // f3N<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    ...
    if_nz r9.w
      rsq r5.w, r5.w
      mul r21.xyz, r5.wwww, r21.xyzx  // f3X<0:NaN:Inf,1:NaN:Inf,2: 0f>
    else 
...
#line 172
      ...
      if_nz r5.w
        rsq r5.w, r7.w
        mul r21.xyz, r5.wwww, r22.xyzx  // f3X<0:NaN:Inf,1: 0f,2:NaN:Inf>
      else 

#line 178
        rsq r5.w, r10.w
        mul r21.xyz, r5.wwww, r23.xyzx  // f3X<0: 0f,1:NaN:Inf,2:NaN:Inf>
...
#line 180
    ...
    rsq r5.w, r5.w
    mul r22.xyz, r5.wwww, r22.xyzx  // f3Y<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    add r23.xyz, r7.xyzx, r14.xyzx
    dp3 r5.w, r23.xyzx, r23.xyzx
    rsq r5.w, r5.w
    mul r24.xyz, r5.wwww, r23.xyzx  // f3H<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    dp3 r21.x, r23.xyzx, r21.xyzx
    dp3 r21.y, r23.xyzx, r22.xyzx
    dp3 r21.z, r23.xyzx, r19.xyzx
    dp3 r5.w, r21.xyzx, r21.xyzx
    rsq r5.w, r5.w
    mul r21.xyz, r5.wwww, r21.xyzx  // f3Ht<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>

#line 187
    dp3 r5.w, r7.xyzx, r7.xyzx
    sqrt r5.w, r5.w  // f3Llength<0:NaN:Inf>
    dp3 r6.w, r14.xyzx, r14.xyzx
    sqrt r6.w, r6.w  // f3Vlength<0:NaN:Inf>
    dp3 r7.w, r19.xyzx, r7.xyzx  // fDotNL<0:NaN:Inf>
    dp3 r8.w, r19.xyzx, r14.xyzx  // fDotNV<0:NaN:Inf>
    div r7.w, r7.w, r5.w  // fDotNL<0:NaN:Inf>
    div r6.w, r8.w, r6.w  // fDotNV<0:NaN:Inf>

#line 197
    dp3 r8.w, r19.xyzx, r24.xyzx  // fDotNH<0:NaN:Inf>
    div r22.xyz, r7.xyzx, r5.wwww
    dp3 r5.w, r22.xyzx, r24.xyzx  // fDotLH<0:NaN:Inf>
    nop 
...
#line 118
    ...
    max r9.w, r9.w, r20.x
    log r9.w, r9.w
    mul r9.w, r9.w, l(2.200000)
    exp r22.x, r9.w  // Mon2Lin<0:Inf:[0f,1.#INFf]>
    mov r9.w, -r20.y
    max r9.w, r9.w, r20.y
    log r9.w, r9.w
    mul r9.w, r9.w, l(2.200000)
    exp r22.y, r9.w  // Mon2Lin<1:Inf:[0f,1.#INFf]>
    mov r9.w, -r20.z
    max r9.w, r9.w, r20.z
    log r9.w, r9.w
    mul r9.w, r9.w, l(2.200000)
    exp r22.z, r9.w  // Mon2Lin<2:Inf:[0f,1.#INFf]>

#line 200
    mov r22.xyz, r22.xyzx  // f3CdLin<0:Inf:[0f,1.#INFf],1:Inf:[0f,1.#INFf],2:Inf:[0f,1.#INFf]>
    mul r9.w, r22.x, l(0.300000)
    mul r10.w, r22.y, l(0.600000)
    add r9.w, r9.w, r10.w
    mul r10.w, r22.z, l(0.100000)
    add r9.w, r9.w, r10.w  // fCdLum<0:NaN:Inf>

#line 204
    lt r10.w, l(0.000000), r9.w
    div r20.xyz, r22.xyzx, r9.wwww
    movc r20.xyz, r10.wwww, r20.xyzx, l(1.000000,1.000000,1.000000,0)  // f3CTint<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r9.w, l(0.080000), cb5[10].z
...
#line 41
    ...
    mul r10.w, r9.w, r9.w  // fm2<0:[0f,1f]>
    mul r10.w, r10.w, r10.w
    mul r9.w, r9.w, r10.w  // SchlickFresnel<0:[-0f,1f]>

#line 210
    mov r9.w, r9.w  // fFL<0:[-0f,1f]>
    nop 
...
#line 41
    ...
    add r10.w, r10.w, l(1.000000)
    max r10.w, r10.w, l(0.000000)
    min r10.w, r10.w, l(1.000000)  // fm<0:[-0f,1f]>
    mul r11.w, r10.w, r10.w  // fm2<0:[0f,1f]>
    mul r11.w, r11.w, r11.w
    mul r10.w, r10.w, r11.w  // SchlickFresnel<0:[-0f,1f]>

#line 211
    mov r10.w, r10.w  // fFV<0:[-0f,1f]>
...
#line 48
    mov r11.w, r2.w  // fSigma<0>

#line 51
    dp3 r12.w, r14.xyzx, r19.xyzx  // fVDotN<0:NaN:Inf>
    dp3 r13.w, r7.xyzx, r19.xyzx  // fLDotN<0:NaN:Inf>
    dp3 r14.w, r7.xyzx, r7.xyzx
    sqrt r14.w, r14.w  // f3Llength<0:NaN:Inf>
    dp3 r15.w, r14.xyzx, r14.xyzx
    sqrt r15.w, r15.w  // f3Vlength<0:NaN:Inf>
    div r12.w, r12.w, r15.w  // fVDotN<0:NaN:Inf>
    div r13.w, r13.w, r14.w  // fLDotN<0:NaN:Inf>
    mov r14.w, -r12.w
    max r15.w, r12.w, r14.w
    mov r17.x, -r15.w
    add r17.x, r17.x, l(1.000000)
    sqrt r17.x, r17.x
    mul r18.w, r15.w, l(-0.018729)
    add r18.w, r18.w, l(0.074261)
    mul r18.w, r15.w, r18.w
    add r18.w, r18.w, l(-0.212114)
    mul r15.w, r15.w, r18.w
    add r15.w, r15.w, l(1.570729)
    mul r15.w, r17.x, r15.w
    mul r17.x, r15.w, l(-2.000000)
    add r17.x, r17.x, l(3.141593)
    lt r14.w, r12.w, r14.w
    and r14.w, r14.w, r17.x
    add r14.w, r14.w, r15.w  // fThetaR<0:NaN:Inf>
    mul r11.w, r11.w, l(3.141593)
    div r11.w, r11.w, l(180.000000)
    mul r11.w, r11.w, r11.w
    mul r11.w, r11.w, l(1.000000)  // fSigma2<0:Inf:[0f,1.#INFf]>
...
#line 63
    ...
    mul r24.xyz, r13.wwww, r19.xyzx
    mov r24.xyz, -r24.xyzx
    add r24.xyz, r7.xyzx, r24.xyzx
    dp3 r12.w, r24.xyzx, r24.xyzx
    rsq r12.w, r12.w
    mul r24.xyz, r12.wwww, r24.xyzx
    dp3 r12.w, r23.xyzx, r24.xyzx  // fCosPhiDiff<0:NaN:Inf>
    mov r15.w, -r13.w
    max r17.x, r13.w, r15.w
    mov r18.w, -r17.x
    add r18.w, r18.w, l(1.000000)
    sqrt r18.w, r18.w
    mul r19.w, r17.x, l(-0.018729)
    add r19.w, r19.w, l(0.074261)
    mul r19.w, r17.x, r19.w
    add r19.w, r19.w, l(-0.212114)
    mul r17.x, r17.x, r19.w
    add r17.x, r17.x, l(1.570729)
    mul r17.x, r18.w, r17.x
    mul r18.w, r17.x, l(-2.000000)
    add r18.w, r18.w, l(3.141593)
    lt r13.w, r13.w, r15.w
    and r13.w, r13.w, r18.w
    add r13.w, r13.w, r17.x  // fThetaI<0:NaN:Inf>
    max r15.w, r14.w, r13.w  // fAlpha<0:NaN:Inf>
    min r13.w, r14.w, r13.w  // fBeta<0:NaN:Inf>
    lt r14.w, l(1.570796), r15.w
    if_nz r14.w
      mov r17.x, l(0)  // OrenNayar<0: 0f>
    endif 
    if_z r14.w
      mul r14.w, r11.w, l(0.500000)
      add r18.w, r11.w, l(0.330000)
      div r14.w, r14.w, r18.w
      mov r14.w, -r14.w
      add r14.w, r14.w, l(1.000000)  // fC1<0:NaN:Inf>
      mul r18.w, r11.w, l(0.450000)
      add r19.w, r11.w, l(0.090000)
      div r18.w, r18.w, r19.w  // fC2<0:NaN:Inf>
      ge r20.w, r12.w, l(0.000000)
      if_nz r20.w
        sincos r20.w, null, r15.w
        mul r20.w, r18.w, r20.w  // fC2<0:NaN:Inf>
      else 

#line 74
        sincos r21.w, null, r15.w
        mul r22.w, r13.w, l(2.000000)
        div r22.w, r22.w, l(3.141593)
        mul r23.x, r22.w, l(1.000000)
        mul r22.w, r22.w, r22.w
        mul r22.w, r22.w, r23.x
        mov r22.w, -r22.w
        add r21.w, r21.w, r22.w
        mul r20.w, r18.w, r21.w  // fC2<0:NaN:Inf>
      endif 
      mul r18.w, r11.w, l(0.125000)
      div r18.w, r18.w, r19.w
      mul r19.w, r15.w, l(4.000000)
      mul r19.w, r13.w, r19.w
      div r19.w, r19.w, l(9.869604)
      mul r19.w, r19.w, r19.w
      mul r19.w, r19.w, l(1.000000)
      mul r18.w, r18.w, r19.w  // fC3<0:NaN:Inf>
      mul r19.w, r12.w, r20.w
      sincos r20.w, null, r13.w
      sincos null, r21.w, r13.w
      ...
      div r15.w, r15.w, l(2.000000)
      sincos r19.w, null, r15.w
      sincos null, r15.w, r15.w
      div r15.w, r19.w, r15.w
      mul r15.w, r15.w, r18.w
      add r14.w, r14.w, r15.w
      mul r14.w, r14.w, l(0.795775)  // fL1<0:NaN:Inf>
      mul r15.w, r11.w, l(0.338204)
      add r11.w, r11.w, l(0.130000)
      div r11.w, r15.w, r11.w
      mul r15.w, r13.w, l(4.000000)
      mul r13.w, r13.w, r15.w
      mul r12.w, r12.w, r13.w
      div r12.w, r12.w, l(9.869604)
      mov r12.w, -r12.w
      add r12.w, r12.w, l(1.000000)
      mul r11.w, r11.w, r12.w  // fL2<0:NaN:Inf>
      add r17.x, r11.w, r14.w  // OrenNayar<0:NaN:Inf>

#line 70
    endif 

#line 214
    mov r17.x, r17.x  // fFd<0:NaN:Inf>

#line 219
    mul r11.w, r5.w, r5.w
    mul r11.w, r2.w, r11.w  // fFss90<0:NaN:Inf>
    add r11.w, r11.w, l(-1.000000)
    mul r9.w, r9.w, r11.w
    add r9.w, r9.w, l(1.000000)
    mul r10.w, r10.w, r11.w
    add r10.w, r10.w, l(1.000000)
    mul r9.w, r9.w, r10.w  // fFss<0:NaN:Inf>
    add r10.w, r6.w, r7.w
    div r10.w, l(1.000000), r10.w
    add r10.w, r10.w, l(-0.500000)
    mul r9.w, r9.w, r10.w
    add r9.w, r9.w, l(0.500000)
    mul r9.w, r9.w, l(1.250000)  // fss<0:NaN:Inf>
...
#line 141
    ...
    mul r17.yzw, r17.yyzw, l(0.000000, 0.000100, 0.000100, 0.000100)
    mul r17.yzw, r17.yyzw, l(0.000000, 0.500000, 0.500000, 0.500000)  // f3M<0:Inf,1:Inf,2:Inf>
    nop 
    div r10.w, cb5[10].x, l(5.000000)  // fM<0:[-6.80565e+037f,6.80565e+037f]>

#line 123
    mul r10.w, r10.w, r10.w
    div r10.w, l(2.000000), r10.w
    add r10.w, r10.w, l(-2.000000)  // RoughnessToSpecPower<0:Inf:[-2f,1.#INFf]>

#line 143
    div r10.w, l(1.000000), r10.w  // fInvS<0:Inf>
    add r17.yz, r10.wwww, r17.yyzy  // f3M<0:NaN:Inf,1:NaN:Inf>
    mul r23.xy, r16.xyxx, r16.xyxx
    mul r23.z, r16.y, r16.x
    mov r23.xyz, -r23.xyzx
    add r17.yzw, r17.yyzw, r23.xxyz  // f3Sigma<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r10.w, r17.z, r17.y
    mul r11.w, r17.w, r17.w
    mov r11.w, -r11.w
    add r10.w, r10.w, r11.w  // fDet<0:NaN:Inf>
    div r21.xy, r21.xyxx, r21.zzzz
    mov r16.xy, -r16.xyxx
    add r16.xy, r16.xyxx, r21.xyxx  // f2H<0:NaN:Inf,1:NaN:Inf>
    mul r11.w, r16.x, r16.x
    mul r11.w, r17.z, r11.w
    mul r12.w, r16.y, r16.y
    mul r12.w, r17.y, r12.w
    add r11.w, r11.w, r12.w
    mul r12.w, r16.x, l(2.000000)
    mul r12.w, r16.y, r12.w
    mul r12.w, r17.w, r12.w
    mov r12.w, -r12.w
    add r11.w, r11.w, r12.w  // fE<0:NaN:Inf>

#line 152
    lt r12.w, l(0.000000), r21.z
    lt r13.w, l(0.000000), r10.w
    and r12.w, r12.w, r13.w
    if_nz r12.w
      mul r11.w, r11.w, l(-0.500000)
      div r11.w, r11.w, r10.w
      mul r11.w, r11.w, l(1.442695)
      exp r11.w, r11.w
      sqrt r10.w, r10.w
      mul r10.w, r10.w, l(3.141593)
      mul r10.w, r10.w, l(2.000000)
      div r10.w, r11.w, r10.w  // fD<0:NaN:Inf>
    else 
      mov r10.w, l(0)  // fD<0: 0f>
    endif 

#line 155
    mov r10.w, r10.w  // LeanMapping<0:NaN:Inf>

#line 229
    mov r10.w, r10.w  // fD<0:NaN:Inf>
    nop 
...
#line 232
    nop 
    mov r5.w, r5.w  // fu<0:NaN:Inf>

#line 41
    mov r5.w, -r5.w
    add r5.w, r5.w, l(1.000000)
    max r5.w, r5.w, l(0.000000)
    min r5.w, r5.w, l(1.000000)  // fm<0:[-0f,1f]>
    mul r11.w, r5.w, r5.w  // fm2<0:[0f,1f]>
    mul r11.w, r11.w, r11.w
    mul r5.w, r5.w, r11.w  // SchlickFresnel<0:[-0f,1f]>

#line 232
    mov r5.w, r5.w  // fFH<0:[-0f,1f]>
    mov r17.yzw, -r20.xxyz
    add r17.yzw, r17.yyzw, l(0.000000, 1.000000, 1.000000, 1.000000)
    mul r17.yzw, r5.wwww, r17.yyzw
    add r17.yzw, r17.yyzw, r20.xxyz  // f3Fs<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    nop 
...
#line 111
    ...
    mul r11.w, r7.w, r7.w  // fb<0:NaN:Inf>
    nop 
    add r12.w, r2.w, r11.w
    mul r13.w, r2.w, r11.w
    mov r13.w, -r13.w
    add r12.w, r12.w, r13.w  // fx<0:NaN:Inf>

#line 86
    mul r12.w, r12.w, r12.w  // Sqr<0:NaN:Inf>

#line 113
    add r12.w, r7.w, r12.w
    div r12.w, l(1.000000), r12.w  // SmithG_GGX<0:NaN:Inf>
...
#line 112
    mul r13.w, r6.w, r6.w  // fb<0:NaN:Inf>
    nop 
    add r14.w, r2.w, r13.w
    mul r2.w, r2.w, r13.w
    mov r2.w, -r2.w
    add r2.w, r2.w, r14.w  // fx<0:NaN:Inf>
...
#line 235
    mul r2.w, r2.w, r12.w  // fGs<0:NaN:Inf>

#line 249
    nop 
    mov r8.w, r8.w  // fDotNH<0:NaN:Inf>
    mul r12.w, l(-0.099000), cb5[12].y
    add r12.w, r12.w, l(0.100000)  // fa<0:[-3.3688e+037f,3.3688e+037f]>

#line 91
    ge r14.w, r12.w, l(1.000000)
    if_nz r14.w
      mov r15.w, l(0.318310)  // GTR1<0: 0.31831f>
    endif 
    if_z r14.w
      mul r12.w, r12.w, r12.w  // fa2<0:Inf:[0f,1.#INFf]>
      add r14.w, r12.w, l(-1.000000)
      mul r16.x, r8.w, r14.w
      mul r8.w, r8.w, r16.x
      add r8.w, r8.w, l(1.000000)  // fT<0:NaN:Inf>
      log r12.w, r12.w
      mul r12.w, r12.w, l(0.693147)
      mul r12.w, r12.w, l(3.141593)
      mul r8.w, r8.w, r12.w
      div r15.w, r14.w, r8.w  // GTR1<0:NaN:Inf>
    endif 
...
#line 249
    ...
    mul r5.w, r5.w, r8.w
    add r4.w, r4.w, r5.w  // fFr<0:Inf>
    nop 

#line 113
    nop 
    add r5.w, r11.w, l(0.062500)
    mul r8.w, r11.w, l(0.062500)
    mov r8.w, -r8.w
    add r5.w, r5.w, r8.w  // fx<0:NaN:Inf>
...
#line 113
    nop 
    add r8.w, r13.w, l(0.062500)
    mul r11.w, r13.w, l(0.062500)
    mov r11.w, -r11.w
    add r8.w, r8.w, r11.w  // fx<0:NaN:Inf>

#line 86
    mul r8.w, r8.w, r8.w  // Sqr<0:NaN:Inf>

#line 113
    add r8.w, r6.w, r8.w
    div r8.w, l(1.000000), r8.w  // SmithG_GGX<0:NaN:Inf>

#line 251
    mul r5.w, r5.w, r8.w  // fGr<0:NaN:Inf>
...
#line 258
      ...
      add r7.y, r7.y, l(3.000000)
      mul r7.x, r7.x, r7.x
      mul r7.x, r7.x, r7.y
      max r7.x, r7.x, l(0.000000)
      min r7.x, r7.x, l(1.000000)  // retMul<0:[0f,1f]>
      mul r7.y, r7.x, r7.x
      mul r7.x, r7.x, r7.y
      mov r7.y, -r17.x
      add r7.y, r7.y, r9.w
      mul r7.y, r7.y, cb5[11].x
      add r7.y, r7.y, r17.x
      mul r7.y, r7.y, l(0.318310)
      mul r20.xyz, r22.xyzx, r7.yyyy
      add r20.xyz, r20.xyzx, cb5[11].zzzz
      mov r7.y, -cb5[10].w
      add r7.y, r7.y, l(1.000000)
      mul r20.xyz, r7.yyyy, r20.xyzx
      add r20.xyz, r20.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
      add r20.xyz, r20.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
      mul r7.xyz, r7.xxxx, r20.xyzx  // BRDF<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>

#line 256
      mov r2.w, l(0)  // fGs<0: 0f>
      mov r4.w, l(0)  // fFr<0: 0f>
    endif 
...
#line 267
        ...
        mul r7.w, r7.w, r8.w
        max r7.w, r7.w, l(0.000000)
        min r7.w, r7.w, l(1.000000)  // retMul<0:[0f,1f]>
        mul r8.w, r7.w, r7.w
        mul r7.w, r7.w, r8.w
        mov r8.w, -r17.x
        add r8.w, r8.w, r9.w
        ...
        add r14.xyz, r14.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
        mul r7.xyz, r7.wwww, r14.xyzx  // BRDF<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 276
      if_z r6.w
        mov r6.w, -r17.x
        add r6.w, r6.w, r9.w
        mul r6.w, r6.w, cb5[11].x
        add r6.w, r6.w, r17.x
        mul r6.w, r6.w, l(0.318310)
        mul r14.xyz, r22.xyzx, r6.wwww
        add r14.xyz, r14.xyzx, cb5[11].zzzz
        mov r6.w, -cb5[10].w
        add r6.w, r6.w, l(1.000000)
        mul r14.xyz, r6.wwww, r14.xyzx
        mul r17.xyz, r17.yzwy, r2.wwww
        ...
        mul r2.w, r4.w, r2.w
        mul r2.w, r15.w, r2.w
        add r7.xyz, r2.wwww, r14.xyzx  // BRDF<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
      endif 
...
#line 289 "lightingconstants.h"
    ...
    ftod r14.xyzw, r7.xyxx
    ftod r7.xy, r7.z
    dmul r14.xyzw, r14.xyzw, r16.zwzw
    dmul r7.xy, r7.xyxy, r16.zwzw
    ftod r16.xyzw, r3.wwww
    ftod r7.zw, r3.w
    dmul r14.xyzw, r14.xyzw, r16.xyzw
    dmul r7.xy, r7.xyxy, r7.zwzw
    dtof r14.xy, r14.xyzw
    dtof r14.z, r7.xyxy
    max r7.xyz, r14.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
    min r7.xyz, r7.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)  // f3LightColorDiffuseResult<0:[0f,1f],1:[0f,1f],2:[0f,1f]>
...
#line 160
    ...
    add r0.w, r0.w, l(0.500000)  // f4ShadowTexCoord<0:NaN:Inf>
    div r3.w, r14.y, l(-2.000000)
    add r14.y, r3.w, l(0.500000)  // f4ShadowTexCoord<1:NaN:Inf>
    utof r2.w, r2.w
...
#line 84
    ...
    add r2.w, r2.w, l(0.000000)  // fShadow<0:[0f,1f]>
    sample_c_lz_indexable(-3,-2,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,2f]>
    sample_c_lz_indexable(-3,-1,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,3f]>
    sample_c_lz_indexable(-3,0,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,4f]>
    sample_c_lz_indexable(-3,1,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,5f]>
    sample_c_lz_indexable(-3,2,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,6f]>
    sample_c_lz_indexable(-3,3,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,7f]>
    sample_c_lz_indexable(-2,-3,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,8f]>
    sample_c_lz_indexable(-2,-2,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,9f]>
    sample_c_lz_indexable(-2,-1,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,10f]>
    sample_c_lz_indexable(-2,0,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,11f]>
    sample_c_lz_indexable(-2,1,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,12f]>
    sample_c_lz_indexable(-2,2,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,13f]>
    sample_c_lz_indexable(-2,3,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,14f]>
    sample_c_lz_indexable(-1,-3,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,15f]>
    sample_c_lz_indexable(-1,-2,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,16f]>
    sample_c_lz_indexable(-1,-1,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,17f]>
    sample_c_lz_indexable(-1,0,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,18f]>
    sample_c_lz_indexable(-1,1,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,19f]>
    sample_c_lz_indexable(-1,2,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,20f]>
    sample_c_lz_indexable(-1,3,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,21f]>
    sample_c_lz_indexable(0,-3,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,22f]>
    sample_c_lz_indexable(0,-2,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,23f]>
    sample_c_lz_indexable(0,-1,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,24f]>
    sample_c_lz_indexable(0,0,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,25f]>
    sample_c_lz_indexable(0,1,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,26f]>
    sample_c_lz_indexable(0,2,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,27f]>
    sample_c_lz_indexable(0,3,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,28f]>
    sample_c_lz_indexable(1,-3,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,29f]>
    sample_c_lz_indexable(1,-2,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,30f]>
    sample_c_lz_indexable(1,-1,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,31f]>
    sample_c_lz_indexable(1,0,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,32f]>
    sample_c_lz_indexable(1,1,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,33f]>
    sample_c_lz_indexable(1,2,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,34f]>
    sample_c_lz_indexable(1,3,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,35f]>
    sample_c_lz_indexable(2,-3,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,36f]>
    sample_c_lz_indexable(2,-2,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,37f]>
    sample_c_lz_indexable(2,-1,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,38f]>
    sample_c_lz_indexable(2,0,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,39f]>
    sample_c_lz_indexable(2,1,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,40f]>
    sample_c_lz_indexable(2,2,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,41f]>
    sample_c_lz_indexable(2,3,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,42f]>
    sample_c_lz_indexable(3,-3,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,43f]>
    sample_c_lz_indexable(3,-2,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,44f]>
    sample_c_lz_indexable(3,-1,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,45f]>
    sample_c_lz_indexable(3,0,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,46f]>
    sample_c_lz_indexable(3,1,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,47f]>
    sample_c_lz_indexable(3,2,0)(texture2d)(float,float,float,float) r3.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r2.w, r2.w, r3.w  // fShadow<0:[0f,48f]>
    sample_c_lz_indexable(3,3,0)(texture2d)(float,float,float,float) r0.w, r14.xyxx, t14.xxxx, s1, r0.w
    add r0.w, r0.w, r2.w  // fShadow<0:[0f,49f]>
...
#line 294
    mov r0.w, r0.w  // fShadowRes<0:[0f,1f]>
    mul r7.xyz, r0.wwww, r7.xyzx  // f3LightColorDiffuseResult<0:[0f,1f],1:[0f,1f],2:[0f,1f]>

#line 299
    mul r7.xyz, r7.xyzx, l(2.000000, 2.000000, 2.000000, 0.000000)  // f3LightColorDiffuseResult<0:[0f,2f],1:[0f,2f],2:[0f,2f]>
...
#line 432 "\\?\C:\Projects\Vektoria_2015-05-22_V13withPatch4\Vektoria\trunk\VektoriaApp\shaders\Source\forwardShading.hlsl"
  mov r7.xyz, r7.xyzx  // f3LightColorDiffuseResult<0:[-0f,2f],1:[-0f,2f],2:[-0f,2f]>
...
#line 448
    ...
    mov r7.xyz, r7.xyzx  // f3LightDiffuseResult<0:[-0f,2f],1:[-0f,2f],2:[-0f,2f]>
...
#line 141
    dp3 r3.w, r20.xyzx, r14.xyzx  // fProduct<0:NaN:Inf>
...
#line 179
    mul r14.xyz, r2.wwww, r3.wwww  // f4DotLN<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mov r18.xyz, -r13.xyzx
    dp3 r3.w, r18.xyzx, r20.xyzx
    max r3.w, r3.w, l(0.000000)
    mul r18.xyz, r1.zzzz, r3.wwww  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    nop 

#line 141
    dp3 r3.w, r20.xyzx, r20.xyzx  // fProduct<0:NaN:Inf>
    mul r3.w, r3.w, l(0.500000)  // fProduct<0:NaN:Inf>
    add r3.w, r3.w, l(0.500000)  // fProduct<0:NaN:Inf>
    mov r3.w, r3.w  // HalfLambert<0:NaN:Inf>
...
#line 182
    mul r3.w, r1.z, r3.w
    add r18.xyz, r3.wwww, r18.xyzx  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 205
      ...
      mul r7.xyz, r7.xyzx, r13.xyzx  // f3LightDiffuseResult<0:[0f,2f],1:[0f,2f],2:[0f,2f]>
    else 

#line 210
      mul r7.xyz, r7.xyzx, r14.xyzx  // f3LightDiffuseResult<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 455
  add r3.xyz, r3.xyzx, r7.xyzx  // f3AccumDiffuse<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 500
mul r0.xyz, r3.xyzx, l(180.000000, 180.000000, 180.000000, 0.000000)  // f3AccumDiffuse<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 201
  ...
  if_nz r3.y
    ...
    and r3.y, r3.y, l(-1)
    mov r3.w, -r3.z
    movc r3.y, r3.y, r3.w, r3.z  // phi<0:[-2.57066f,2.57066f]>
  else 
...
#line 205
  ...
  if_nz r3.x
    ...
    and r3.x, r3.x, l(-1)
    mov r4.w, -r3.w
    movc r3.x, r3.x, r4.w, r3.w  // phi<0:[-2.57066f,2.57066f]>
    add r3.y, r3.x, l(3.141593)  // phi<0:[0.57093f,5.71226f]>
...
#line 210
  ...
  if_nz r3.z
    ...
    and r3.z, r3.z, l(-1)
    mov r4.w, -r3.w
    movc r3.z, r3.z, r4.w, r3.w  // phi<0:[-2.57066f,2.57066f]>
    add r3.y, r3.z, l(3.141593)  // phi<0:[0.57093f,5.71226f]>
...
#line 215
  ...
  if_nz r2.x
    ...
    and r1.x, r1.x, l(-1)
    mov r2.x, -r1.z
    movc r1.x, r1.x, r2.x, r1.z  // phi<0:[-2.57066f,2.57066f]>
    add r3.y, r1.x, l(6.283185)  // phi<0:[3.71252f,8.85385f]>

#line 215
  endif 

#line 220
  div r3.x, r3.y, l(6.283185)  // phi<0:[-0.409134f,1.40913f]>
  mov r1.x, -r1.y
  max r1.z, r1.x, r1.y
  mov r2.x, -r1.z
  ...
  mov r3.x, r3.x  // SphericalMapping<0:[-0.409134f,1.40913f]>
...
#line 201
  ...
  if_nz r1.z
    ...
    and r1.z, r1.z, l(-1)
    mov r4.w, -r2.x
    movc r1.z, r1.z, r4.w, r2.x  // phi<0:[-2.57066f,2.57066f]>
  else 
...
#line 205
  ...
  if_nz r1.y
    ...
    and r1.y, r1.y, l(-1)
    mov r5.x, -r4.w
    movc r1.y, r1.y, r5.x, r4.w  // phi<0:[-2.57066f,2.57066f]>
    add r1.z, r1.y, l(3.141593)  // phi<0:[0.57093f,5.71226f]>
...
#line 210
  ...
  if_nz r2.x
    ...
    and r2.x, r2.x, l(-1)
    mov r5.x, -r4.w
    movc r2.x, r2.x, r5.x, r4.w  // phi<0:[-2.57066f,2.57066f]>
    add r1.z, r2.x, l(3.141593)  // phi<0:[0.57093f,5.71226f]>
...
#line 215
  ...
  if_nz r1.x
    ...
    add r1.z, r1.x, l(6.283185)  // phi<0:[3.71252f,8.85385f]>

#line 215
  endif 

#line 220
  div r1.x, r1.z, l(6.283185)  // phi<0:[-0.409134f,1.40913f]>
  mov r1.z, -r2.z
  max r2.x, r1.z, r2.z
  mov r2.y, -r2.x
...
ret 
// Approximately 2317 instruction slots used
